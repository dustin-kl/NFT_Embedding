    ...
    <div className="w-1/4 flex flex-col ">
      ...
      <div className="flex flex-col y-gap-2 px-2 py-3 bg-slate-100 rounded-b-md h-110 ">
        ...
        <div className="flex-grow">
          <p className="text-gray-600">
            Description:{" "}
            {nft.description !== "" ? nft.description.substr(0, 150) : "NA"}
          </p>
        </div>
        <div id="pi">BLABLA</div>
        <div className="flex justify-center mb-1 mt-4">
          <button
            className="py-2 px-4 bg-blue-500 w-1/2 text-center rounded-m text-white cursor-pointer"
            onClick={() => {
              setContractAddressList([]);
              setInputDescription(nft.description);

              // da kommt code um contactAddressList zu initialisieren

              <pyscript>
                print('Hello, World!') pyscript.write('pi', 'π is approximately
                3')
              </pyscript>;
              console.log("hellloooo");
              console.log(document.getElementById("pi").innerHTML);

              setContractAddressList([
                "0xBC4CA0EdA7647A8aB7C2061c2E118A18a936f13D",
                "0x34d85c9CDeB23FA97cb08333b511ac86E1C4E258",
              ]);
              console.log("bla001", contractAddressList);
              ///////////////////////////////////////////////////////////
