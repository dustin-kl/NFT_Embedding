...
OWNER_DICT = {
    'owner0': {
        'address': '0x376A273cFe9512b9f60304D289eccFE6905c020a', 
        'nfts': ['0x0d5d0e3418ef2d699faefa3ba5f0db2928d4633d','0x2086f6f916a6bf22920cb9b28fc4119ce245dff4','0x22ca15d0817bac27696437cbba8143e54973f6c3'],
        'ids': ['027D','5CC2', '01C4']
        }, 
    'owner1': {
...
for l, owner in enumerate(OWNER_DICT.keys()):
    ...
    for p, nft in enumerate(OWNER_DICT[owner]['nfts']):
        ...
        token_id = OWNER_DICT[owner]['ids'][p]
        URL2 = f"https://eth-mainnet.alchemyapi.io/v2/demo/getNFTMetadata?contractAddress={nft_contract_address}&tokenId={1}"
